...
def process_config():
        ...
        data_arg.add_argument('--cur_fold', type=int, default=0, help='cur_fold for the cross validation')  # -1 indicates iterating whole folds
        ...
        data_arg.add_argument('--tokenizer_type', type=str, default='hfl/chinese-xlnet-base', help="types of tokenizer")  # "word", "bert-base-uncased", or "xlnet-base-cased"
        net_arg.add_argument('--path_pretrained_emb', type=str, default='hfl/chinese-xlnet-base')  # path or "bert-base-uncased"
        net_arg.add_argument('--pretrained_weights', type=str, default='hfl/chinese-xlnet-base')  # path for pretrained model
