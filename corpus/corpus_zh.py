...
class CorpusZH(CorpusBase):

    #
    def __init__(self, config):
        super(CorpusZH, self).__init__(config)
    ...
    def _sent_split_corpus(self, arr_input_text):
        ...
        # stanza.download('en')
        tokenizer_stanza = stanza.Pipeline('zh', processors='tokenize', use_gpu=True)
